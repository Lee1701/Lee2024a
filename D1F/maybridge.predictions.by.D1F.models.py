...
##### Maybridge prediction by BindingDB-Kd-pretrained-v0.1.5 & PDBbind2020-full-finetuned models (D1F) (with ray and jobarray) #####
...
if __name__ == "__main__":
    ...
    MODEL_DIR1 = PD+'/models/regression/finetuned/BDB-pretrained-v015-PDBbind2020-refined-regsm-full/'
    MODEL_DIR2 = '/jobarray-RCV-'
    
    INPUT_FILE1 = PD+'/data/Maybridge_HitDiscover.smiles.unique.v2.csv'

    RESULT_FOLDER = './'
    OUTPUT_FILENAME0 = 'maybridge.predictions.by.D1F.models.'
